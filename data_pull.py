...
# write new json file to directory
cur_time = datetime.now().strftime('%Y%m%d-%H%M%S')
with open('budget-' + cur_time + '.json', 'w') as f:
    json.dump(budget_json, f, ensure_ascii=False)

# add data pull time to file
with open('last_data_pull.csv', 'a') as fd:
    fd.write('\n' + cur_time)